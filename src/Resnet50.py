...
def main():
    ...
    model.summary()
    plot_model(model, to_file='./images/resnet50_model_structure.png', show_shapes=False)

    model_part = Model(inputs=model.input, outputs=model.layers[10].output)
    plot_model(model_part, to_file='./images/resnet50_model_part.png', show_shapes=True)
    ...
    with open('./models/resnet50_history.pkl', 'wb') as f:
    ...
    plt.savefig('./images/resnet50_confusion_matrix.png')
    plt.show()
